...
if(mysqli_num_rows($query) > 0){
	...
	$coverpic = '<img src="images/defaultcoverpic.png" alt="Default Cover Picture" />';
}
?>
<!DOCTYPE html>
<html>
...
div#photo_showcase{float:right; /*background:url(style/photo_showcase_bg.jpg) no-repeat*/
	border: 2px solid grey; width:136px; height:127px; margin:20px 30px 0px 0px; cursor:pointer;}
